    ...
    <div class="card-content">
      <div class="w-full h-1/2 flex flex-col items-center justify-end">
        <img
          ...
          class="w-[6vw] h-[6vw] object-cover object-center rounded-full mb-3 bg-evo-gray z-10"
          alt="Player"
        />
        <div
          class="rounded-full text-white text-center text-3xl relative flex items-center justify-center"
        >
          <span class="z-10">{{ props.player.name }}</span>
          <i
            class="icon absolute bg-icon"
            :class="{
        ...
        <div class="w-full h-1/4">
          ...
          <div class="w-full h-1 rounded-full bg-evo-gray">
            <div
              ...
              :style="{ width: `${props.player.stats.firepower}%` }"
            ></div>
          </div>
        </div>
        <div>
          <div class="flex justify-between w-full mb-3">
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.entrying}%` }"
                ></div>
            ...
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.trading}%` }"
                ></div>
                <div class="h-1 w-full rounded-full gradient-line absolute inset-0"></div>
              </div>
            </div>
          ...
          <div class="flex justify-between w-full mb-3">
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.opening}%` }"
                ></div>
                <div class="h-1 w-full rounded-full gradient-line absolute inset-0"></div>
              </div>
            </div>
            ...
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.clutching}%` }"
                ></div>
                <div class="h-1 w-full rounded-full gradient-line absolute inset-0"></div>
              </div>
            </div>
          ...
          <div class="flex justify-between w-full">
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.sniping}%` }"
                ></div>
                <div class="h-1 w-full rounded-full gradient-line absolute inset-0"></div>
              </div>
            </div>
            ...
            <div class="w-2/5">
              ...
              <div class="w-full h-1 rounded-full overflow-hidden relative">
                ...
                <div
                  class="h-1 rounded-full bg-white absolute inset-0"
                  :style="{ width: `${props.player.stats.utility}%` }"
                ></div>
                <div class="h-1 w-full rounded-full gradient-line absolute inset-0"></div>
              </div>
            </div>
